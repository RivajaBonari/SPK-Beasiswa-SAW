                        ...
                        <tbody>
                            <?php while ($data = $exe->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <p class="mb-0 fw-normal"><?= $data['ipk']; ?></p>
                                    </td>
                                    <td>
                                        <p class="mb-0 fw-normal"><?= $data['penghasilan_ortu']; ?></p>
                                    </td>
                                    <td>
                                        <p class="mb-0 fw-normal"><?= $data['tanggungan']; ?></p>
                                    </td>
                                    <td>
                                        <p class="mb-0 fw-normal"><?= $data['organisasi']; ?></p>
                                    </td>
                                    <td>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        editButtons.forEach(function(button) {
            button.addEventListener('click', function() {
                ...
                document.getElementById('edit_tanggungan').value = tanggungan;
